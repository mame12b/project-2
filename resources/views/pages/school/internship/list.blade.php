                                ...
                                <tbody>
                                    @foreach ($internships as $internship)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('school.department.view', $internship->department->id) }}">
                                                    {{ $internship->department->name }}
                                                </a>
                                            </td>
                                            <td>
                                                @if (!$internship->isEnded() && $internship->isStarted() && $internship->status != '2')
                                                <a href="{{ route('school.internship.start', $internship->id) }}">
                                                ...
                                                @endif
                                                <a href="{{ route('school.internship.view', $internship->id) }}">
                                                ...
                                                <a href="{{ route('school.internship.delete', $internship->id) }}" onclick="if(confirm('Are you sure, you want to End {{ $internship->title }}?') == false){event.preventDefault()}">
                                                ...
                                                @else
                                                <a href="{{ route('school.internship.delete', $internship->id) }}" onclick="if(confirm('Are you sure, you want to delete {{ $internship->title }}?') == false){event.preventDefault()}">
                                                    <button class="btn btn-danger btn-xs btn-flat">
