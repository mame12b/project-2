...
@section('header')
    @include('layout.header', ['title' => 'Admin | Internship | View'])
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.internship.list') }}">List</a></li>
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="card-tools mr-5">
                                <a href="{{ route('admin.internship.list') }}"><button type="button" class="btn btn-tool"><i
