...
@section('header')
    @include('layout.header', ['title' => 'Admin | Department | Edit'])
@endsection
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.department.list') }}">List</a></li>
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="card-tools mr-5">
                                <a href="{{ route('admin.department.list') }}"><button type="button" class="btn btn-tool"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Select School</label> <i class="text-danger font-weight-bold">*</i>
                                            <select name="school_id" id="school_id"
                                                class="form-control @error('school_id') is-invalid @enderror select2"
                                                autofocus>
                                                <option value="{{ $department->school->id }}">{{ $department->school->name }}</option>
                                                @foreach ($school_list as $school)
                                                    @continue($school->id == $department->school->id)
