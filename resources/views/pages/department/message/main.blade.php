...
<body>
                                                    ...
                                                    @if (count($single_rooms) > 0)
                                                        ...
                                                        @foreach ($single_rooms as $room)
                                                            <div id="messageRoom_{{ $room->id }}"
                                                                ...
                                                                onclick="getSingleRoomMessage(this, {{ $room->id }}, '{{ ucwords($room->user->getName()) }}', '{{ ucwords($room->internship->title) }}', '{{ $room->user->avatar }}');">
                                                                <div class="valign">
                                                                    <div class="notification-user-avatar avatar">
                                                                        <span class="new-message-alert hidden" style="background: #28a745;"></span>
                                                                        <img alt="Scottie"
                                                                            src="{{ asset('uploads/avatar/'.$room->user->avatar) }}" />
                                                                    </div>
                                                                    <div class="notification-text">
                                                                        <div class="ajax-time"
                                                                            title="2022-08-28T18:22:19+00:00">
                                                                            {{ ucwords($room->internship->title) }}
                                                                        </div>
                                                                        <span
                                                                            class="truncate">{{ ucwords($room->user->getName()) }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        @endforeach
    ...
    @include('pages.department.inc.messages')
</body>
